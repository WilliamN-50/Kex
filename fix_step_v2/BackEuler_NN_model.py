...
def _local_truncation_error(data, func, num_y):
    ...
    return 1/data[2]**2 * (y_second - y_first - data[2] * func(data[1], y_second))


def main():
    diff_eq = gd.Diff_eq_Van_der(t_0=0, t_end=10, y_0=[1, 2])
    in_data = np.load("eq_van_der_outfile_1_2_100p.npy")
    batch_size = 500
    ...
    train.save_model("implicEuler_eq_van_der_model_Adam_no_noise_1_2_100p_100ep_lr5_10_4.pth")
    train.plot_loss()
